...
const MyCart = () => {
  ...
  if(cart.length===0){
return( 
  <div className='justify-center items-center flex flex-col min-h-[50vh] sm:my-8 my-4 font-semibold'>
 ...
 <NavLink to='/product'> <button className='bg-nav  px-10 sm:px-14 py-1 rounded-lg mt-2 mr-2 hover:text-black'>Shop Now</button></NavLink>
  ...
  return (
    <>
    <div className='sm:my-10 my-7 p-5'>
    ...
    <hr className='sm:mt-10 mt-3 lg:w-[80vw]  w-[90%] mx-auto'></hr>
      ...
      <Ordering total_amount={total_amount} shipping_fee={shipping_fee}/>
      </div>
