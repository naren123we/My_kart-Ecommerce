...
const Testimonial = () => {
  return (
    <div className="bg-slate-50  flex md:flex-row flex-col justify-center md:space-x-4 lg:space-x-10 md:m-6 my-4 md:p-5 p-3 md:rounded-2xl  items-center">
         ...
         <span className="sm:text-4xl text-3xl font-bold font-serif"><span>Lowest Prices</span><br/><span> Best Quality Shopping</span></span>
         <div className="flex md:space-x-6 space-x-4 pt-3">
         <div className="flex">
          <img src={free} className='h-[50px] w-[50px] rounded-full bg-white p-1' alt="free-img"></img>
         <span><span>Fast</span><br/><span>Delivery</span></span>
         </div>
         <div className="flex">
         <img src={cash} className='h-[50px] w-[50px] rounded-full bg-white p-1' alt='cash-img'></img>
        <span><span>Cash on</span> <br/><span>Delivery</span></span> 
         </div>
         <div  className="flex">
         <img src={back} className='h-[50px] w-[50px] rounded-full bg-white p-1' alt='back-img'></img>
